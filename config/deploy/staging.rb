...
server 'front-app01.stage.doctor.rambler.tech', roles: %w(front)
server 'back01.stage.doctor.rambler.tech',      roles: %w(backend db), primary: true
server 'queue01.stage.doctor.rambler.tech',     roles: %w(queue)

set :ssh_options, user: 'doctor'

set :webdav_endpoint, 'http://night.webdav.rambler.tech/doctor/doctor_stage'
